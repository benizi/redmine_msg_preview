...
var Facebox = Class.create({
  initialize  : function(extra_set){
    this.settings = {
      ...
      // redmine in general      
      close_image   : '/plugin_assets/redmine_msg_preview/images/facebox/closelabel.gif',
      inited        : true, 
      facebox_html  : '\
          ...
          <tbody> \
            ...
            <tr> \
              ...
              <td class="body"> \
                ...
                <div class="footer"> \
                  <a href="#" class="close"> \
                    <img src="/plugin_assets/redmine_msg_preview/images/facebox/closelabel.gif" title="close" class="close_image" /> \
                  </a> \
                </div> \
              </td> \
              <td class="b"/> \
